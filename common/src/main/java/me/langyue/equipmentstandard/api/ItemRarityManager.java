...
public class ItemRarityManager {
    ...
    private static final Set<ItemRarity.Rarity> DEFAULT_RARITY = new LinkedHashSet<>() {{
        ...
        add(new ItemRarity.Rarity("Uncommon", 50, Component.empty(), ChatFormatting.GREEN));
        add(new ItemRarity.Rarity("Rare", 350, Component.empty(), ChatFormatting.BLUE));
        add(new ItemRarity.Rarity("Epic", 600, Component.empty(), ChatFormatting.LIGHT_PURPLE));
