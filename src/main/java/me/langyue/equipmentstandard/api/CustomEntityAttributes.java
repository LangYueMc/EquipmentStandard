...
public class CustomEntityAttributes {
    ...
    public static final EntityAttribute CRIT_CHANCE = register("generic.crit_chance");
    public static final EntityAttribute RANGE_ATTACK_DAMAGE = register("generic.range_attack_damage");
